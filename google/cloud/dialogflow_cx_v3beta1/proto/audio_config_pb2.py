...
# source: google/cloud/dialogflow_cx_v3beta1/proto/audio_config.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="google/cloud/dialogflow_cx_v3beta1/proto/audio_config.proto",
...
_OUTPUTAUDIOENCODING = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="OUTPUT_AUDIO_ENCODING_MP3_64_KBPS",
            index=3,
            number=4,
            serialized_options=None,
            type=None,
        ...
        _descriptor.EnumValueDescriptor(
            name="OUTPUT_AUDIO_ENCODING_MULAW",
            index=5,
            number=5,
            serialized_options=None,
            type=None,
...
_SPEECHWORDINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="word",
            full_name="google.cloud.dialogflow.cx.v3beta1.SpeechWordInfo.word",
            index=0,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="start_offset",
            full_name="google.cloud.dialogflow.cx.v3beta1.SpeechWordInfo.start_offset",
            index=1,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="end_offset",
            full_name="google.cloud.dialogflow.cx.v3beta1.SpeechWordInfo.end_offset",
            index=2,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="confidence",
            full_name="google.cloud.dialogflow.cx.v3beta1.SpeechWordInfo.confidence",
            index=3,
            number=4,
            type=2,
            cpp_type=6,
...
_INPUTAUDIOCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="audio_encoding",
            full_name="google.cloud.dialogflow.cx.v3beta1.InputAudioConfig.audio_encoding",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.dialogflow.cx.v3beta1.InputAudioConfig.sample_rate_hertz",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.dialogflow.cx.v3beta1.InputAudioConfig.enable_word_info",
            index=2,
            number=13,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="phrase_hints",
            full_name="google.cloud.dialogflow.cx.v3beta1.InputAudioConfig.phrase_hints",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="model",
            full_name="google.cloud.dialogflow.cx.v3beta1.InputAudioConfig.model",
            index=4,
            number=7,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="model_variant",
            full_name="google.cloud.dialogflow.cx.v3beta1.InputAudioConfig.model_variant",
            index=5,
            number=10,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.dialogflow.cx.v3beta1.InputAudioConfig.single_utterance",
            index=6,
            number=8,
            type=8,
            cpp_type=7,
...
_VOICESELECTIONPARAMS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="google.cloud.dialogflow.cx.v3beta1.VoiceSelectionParams.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="ssml_gender",
            full_name="google.cloud.dialogflow.cx.v3beta1.VoiceSelectionParams.ssml_gender",
            index=1,
            number=2,
            type=14,
            cpp_type=8,
...
_SYNTHESIZESPEECHCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="speaking_rate",
            full_name="google.cloud.dialogflow.cx.v3beta1.SynthesizeSpeechConfig.speaking_rate",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="pitch",
            full_name="google.cloud.dialogflow.cx.v3beta1.SynthesizeSpeechConfig.pitch",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="volume_gain_db",
            full_name="google.cloud.dialogflow.cx.v3beta1.SynthesizeSpeechConfig.volume_gain_db",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.dialogflow.cx.v3beta1.SynthesizeSpeechConfig.effects_profile_id",
            index=3,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="voice",
            full_name="google.cloud.dialogflow.cx.v3beta1.SynthesizeSpeechConfig.voice",
            index=4,
            number=4,
            type=11,
            cpp_type=10,
...
_OUTPUTAUDIOCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="audio_encoding",
            full_name="google.cloud.dialogflow.cx.v3beta1.OutputAudioConfig.audio_encoding",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="sample_rate_hertz",
            full_name="google.cloud.dialogflow.cx.v3beta1.OutputAudioConfig.sample_rate_hertz",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.dialogflow.cx.v3beta1.OutputAudioConfig.synthesize_speech_config",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
SpeechWordInfo = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "google.cloud.dialogflow_cx_v3beta1.proto.audio_config_pb2",
...
InputAudioConfig = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      sample_rate_hertz:
          ...
          Refer to `Cloud Speech API documentation
          <https://cloud.google.com/speech-to-text/docs/basics>`__ for
          more details.
      enable_word_info:
          Optional. If ``true``, Dialogflow returns [SpeechWordInfo][goo
          gle.cloud.dialogflow.cx.v3beta1.SpeechWordInfo] in [StreamingR
          ecognitionResult][google.cloud.dialogflow.cx.v3beta1.Streaming
          RecognitionResult] with information about the recognized
      ...
      model_variant:
          Optional. Which variant of the [Speech model][google.cloud.dia
          logflow.cx.v3beta1.InputAudioConfig.model] to use.
      single_utterance:
...
VoiceSelectionParams = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      name:
          ...
          language_code and [ssml_gender][google.cloud.dialogflow.cx.v3b
          eta1.VoiceSelectionParams.ssml_gender].
      ssml_gender:
          Optional. The preferred gender of the voice. If not set, the
          service will choose a voice based on the other parameters such
          as language_code and [name][google.cloud.dialogflow.cx.v3beta1
          .VoiceSelectionParams.name]. Note that this is only a
