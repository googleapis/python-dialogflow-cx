...
"""Accesses the google.cloud.dialogflow.cx.v3beta1 EntityTypes API."""
...
from google.cloud.dialogflowcx_v3beta1.gapic import entity_types_client_config
...
class EntityTypesClient(object):
    ...
    _INTERFACE_NAME = "google.cloud.dialogflow.cx.v3beta1.EntityTypes"
    ...
    @classmethod
    def entity_type_path(cls, project, location, agent, entity_type):
    ...
    def list_entity_types(
        ...
        Args:
            parent (str): Required. The agent to list all entity types for. Format:
                ``projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>``.
            language_code (str): The language to list entity types for. The following fields are
                language dependent:
        ...
        Returns:
            ...
            An iterable of :class:`~google.cloud.dialogflowcx_v3beta1.types.EntityType` instances.
    ...
    def get_entity_type(
        ...
        Example:
            ...
            >>> client = dialogflowcx_v3beta1.EntityTypesClient()
            >>>
            >>> name = client.entity_type_path('[PROJECT]', '[LOCATION]', '[AGENT]', '[ENTITY_TYPE]')
            >>>
        ...
        Args:
            ...
            language_code (str): The language to retrieve the entity type for. The following fields
        ...
        Returns:
            A :class:`~google.cloud.dialogflowcx_v3beta1.types.EntityType` instance.
    ...
    def create_entity_type(
        ...
        Args:
            parent (str): Required. The agent to create a entity type for. Format:
                ``projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>``.
            entity_type (Union[dict, ~google.cloud.dialogflowcx_v3beta1.types.EntityType]): Required. The entity type to create.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.dialogflowcx_v3beta1.types.EntityType`
            language_code (str): The language of the following fields in ``entity_type``:
    ...
    def update_entity_type(
        ...
        Args:
            entity_type (Union[dict, ~google.cloud.dialogflowcx_v3beta1.types.EntityType]): Required. The entity type to update.
    ...
    def delete_entity_type(
        ...
        Args:
            name (str): Required. The name of the entity type to delete. Format:
                ``projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/entityTypes/<Entity Type ID>``.
            force (bool): This field has no effect for entity type not being used. For entity
                types that are used by intents or pages:

                -  If ``force`` is set to false, an error will be returned with message
                   indicating the referencing resources.
                -  If ``force`` is set to true, Dialogflow will remove the entity type,
                   as well as any references to the entity type (i.e. Page ``parameter``
        ...
        request = entity_type_pb2.DeleteEntityTypeRequest(name=name, force=force,)
        if metadata is None:
            metadata = []
        metadata = list(metadata)
        try:
