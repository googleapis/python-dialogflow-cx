...
"""Accesses the google.cloud.dialogflow.cx.v3beta1 SessionEntityTypes API."""
...
from google.cloud.dialogflowcx_v3beta1.gapic import session_entity_types_client_config
...
class SessionEntityTypesClient(object):
    ...
    _INTERFACE_NAME = "google.cloud.dialogflow.cx.v3beta1.SessionEntityTypes"
    ...
    @classmethod
    def session_entity_type_path(cls, project, location, agent, session, entity_type):
    ...
    def list_session_entity_types(
        ...
        Returns:
            ...
            An iterable of :class:`~google.cloud.dialogflowcx_v3beta1.types.SessionEntityType` instances.
    ...
    def get_session_entity_type(
        ...
        Returns:
            A :class:`~google.cloud.dialogflowcx_v3beta1.types.SessionEntityType` instance.
    ...
    def create_session_entity_type(
        ...
        Args:
            parent (str): Required. The session to create a session entity type for. Format:
                ...
                If ``Environment ID`` is not specified, we assume default 'draft'
                environment.
            session_entity_type (Union[dict, ~google.cloud.dialogflowcx_v3beta1.types.SessionEntityType]): Required. The session entity type to create.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.dialogflowcx_v3beta1.types.SessionEntityType`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will
                be retried using a default configuration.
            timeout (Optional[float]): The amount of time, in seconds, to wait
    ...
    def update_session_entity_type(
        ...
        Args:
            session_entity_type (Union[dict, ~google.cloud.dialogflowcx_v3beta1.types.SessionEntityType]): Required. The session entity type to update. Format:
                ``projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/sessions/<Session ID>/entityTypes/<Entity Type ID>``
                or
                ``projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/environments/<Environment ID>/sessions/<Session ID>/entityTypes/<Entity Type ID>``.
                If ``Environment ID`` is not specified, we assume default 'draft'
    ...
    def delete_session_entity_type(
        ...
        Args:
            name (str): Required. The name of the session entity type to delete. Format:
                ``projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/sessions/<Session ID>/entityTypes/<Entity Type ID>``
                or
                ``projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/environments/<Environment ID>/sessions/<Session ID>/entityTypes/<Entity Type ID>``.
                If ``Environment ID`` is not specified, we assume default 'draft'
