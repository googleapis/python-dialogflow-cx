...
class SessionsGrpcTransport(object):
    ...
    google.cloud.dialogflow.cx.v3beta1 Sessions API.
    ...
    def match_intent(self):
        """Return the gRPC stub for :meth:`SessionsClient.match_intent`.
        ...
        Returns:
            Callable: A callable which accepts the appropriate
                ...
                deserialized response object.
        """
        return self._stubs["sessions_stub"].MatchIntent

    @property
    def fulfill_intent(self):
        """Return the gRPC stub for :meth:`SessionsClient.fulfill_intent`.
        ...
        Returns:
            Callable: A callable which accepts the appropriate
                ...
                deserialized response object.
        """
        return self._stubs["sessions_stub"].FulfillIntent
