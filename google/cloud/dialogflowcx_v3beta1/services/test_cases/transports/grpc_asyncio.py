...
class TestCasesGrpcAsyncIOTransport(TestCasesTransport):
    ...
    def batch_delete_test_cases(
        self,
    ) -> Callable[[test_case.BatchDeleteTestCasesRequest], Awaitable[empty.Empty]]:
    ...
    def run_test_case(
        self,
    ) -> Callable[[test_case.RunTestCaseRequest], Awaitable[operations.Operation]]:
    ...
    def batch_run_test_cases(
        ...
        [test_case.BatchRunTestCasesRequest], Awaitable[operations.Operation]
    ]:
    ...
    def import_test_cases(
        self,
    ) -> Callable[[test_case.ImportTestCasesRequest], Awaitable[operations.Operation]]:
    ...
    def export_test_cases(
        self,
    ) -> Callable[[test_case.ExportTestCasesRequest], Awaitable[operations.Operation]]:
