...
class ListSessionEntityTypesPager:
    ...
    :class:`google.cloud.dialogflowcx_v3.types.ListSessionEntityTypesResponse` object, and
    ...
    All the usual :class:`google.cloud.dialogflowcx_v3.types.ListSessionEntityTypesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (google.cloud.dialogflowcx_v3.types.ListSessionEntityTypesResponse):
