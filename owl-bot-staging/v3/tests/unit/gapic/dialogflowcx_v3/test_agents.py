...
from google.cloud.dialogflowcx_v3.services.agents import AgentsAsyncClient
...
def test_agents_client_client_options_from_dict():
    with mock.patch('google.cloud.dialogflowcx_v3.services.agents.transports.AgentsGrpcTransport.__init__') as grpc_transport:
...
def test_list_agents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v3/{parent=projects/*/locations/*}/agents" % client.transport._host, args[1])
...
def test_get_agent_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{name=projects/*/locations/*/agents/*}" % client.transport._host, args[1])
...
def test_update_agent_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{agent.name=projects/*/locations/*/agents/*}" % client.transport._host, args[1])
...
def test_get_agent_validation_result_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{name=projects/*/locations/*/agents/*/validationResult}" % client.transport._host, args[1])
...
def test_agents_base_transport():
    ...
    with mock.patch('google.cloud.dialogflowcx_v3.services.agents.transports.AgentsTransport.__init__') as Transport:
...
def test_agents_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflowcx_v3.services.agents.transports.AgentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_agents_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflowcx_v3.services.agents.transports.AgentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AgentsTransport()
        adc.assert_called_once()
