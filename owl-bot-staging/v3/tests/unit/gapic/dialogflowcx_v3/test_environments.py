...
from google.cloud.dialogflowcx_v3.services.environments.transports.base import _API_CORE_VERSION
from google.cloud.dialogflowcx_v3.services.environments.transports.base import _GOOGLE_AUTH_VERSION
