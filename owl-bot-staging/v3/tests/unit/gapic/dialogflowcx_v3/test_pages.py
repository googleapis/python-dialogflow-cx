...
def test_pages_client_client_options_from_dict():
    with mock.patch('google.cloud.dialogflowcx_v3.services.pages.transports.PagesGrpcTransport.__init__') as grpc_transport:
...
def test_list_pages_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, page.Page)
                   for i in results)
...
def test_list_pages_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = page.ListPagesResponse.to_json(page.ListPagesResponse())
        ...
        client.list_pages(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_pages_rest_bad_request(transport: str = 'rest', request_type=page.ListPagesRequest):
    client = PagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_pages_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v3/{parent=projects/*/locations/*/agents/*/flows/*}/pages" % client.transport._host, args[1])
...
def test_get_page_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.get_page(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_page_rest_bad_request(transport: str = 'rest', request_type=page.GetPageRequest):
    client = PagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_page_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{name=projects/*/locations/*/agents/*/flows/*/pages/*}" % client.transport._host, args[1])
...
def test_create_page_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("languageCode", )) & set(("parent", "page", )))
...
def test_create_page_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.create_page(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_page_rest_bad_request(transport: str = 'rest', request_type=gcdc_page.CreatePageRequest):
    client = PagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_page_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("languageCode", "updateMask", )) & set(("page", )))
...
def test_update_page_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.update_page(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_page_rest_bad_request(transport: str = 'rest', request_type=gcdc_page.UpdatePageRequest):
    client = PagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_page_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{page.name=projects/*/locations/*/agents/*/flows/*/pages/*}" % client.transport._host, args[1])
...
def test_delete_page_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.delete_page(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_page_rest_bad_request(transport: str = 'rest', request_type=page.DeletePageRequest):
    client = PagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_pages_base_transport():
    ...
    with mock.patch('google.cloud.dialogflowcx_v3.services.pages.transports.PagesTransport.__init__') as Transport:
...
def test_pages_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflowcx_v3.services.pages.transports.PagesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_pages_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflowcx_v3.services.pages.transports.PagesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.PagesTransport()
        adc.assert_called_once()
...
def test_pages_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.PagesGrpcTransport, transports.PagesGrpcAsyncIOTransport])
def test_pages_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.PagesGrpcTransport, transports.PagesGrpcAsyncIOTransport])
def test_pages_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
