...
from .base import SecuritySettingsServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class SecuritySettingsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_security_settings(self, request: gcdc_security_settings.CreateSecuritySettingsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcdc_security_settings.CreateSecuritySettingsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_create_security_settings(self, response: gcdc_security_settings.SecuritySettings) -> gcdc_security_settings.SecuritySettings:
        ...
        """
        return response
    def pre_delete_security_settings(self, request: security_settings.DeleteSecuritySettingsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[security_settings.DeleteSecuritySettingsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_security_settings(self, request: security_settings.GetSecuritySettingsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[security_settings.GetSecuritySettingsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_security_settings(self, response: security_settings.SecuritySettings) -> security_settings.SecuritySettings:
        ...
        """
        return response
    def pre_list_security_settings(self, request: security_settings.ListSecuritySettingsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[security_settings.ListSecuritySettingsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_security_settings(self, response: security_settings.ListSecuritySettingsResponse) -> security_settings.ListSecuritySettingsResponse:
        ...
        """
        return response
    def pre_update_security_settings(self, request: gcdc_security_settings.UpdateSecuritySettingsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcdc_security_settings.UpdateSecuritySettingsRequest, Sequence[Tuple[str, str]]]:
