...
from google.cloud.dialogflowcx_v3beta1.services.changelogs.transports.base import _GOOGLE_AUTH_VERSION
...
def test_changelogs_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_list_changelogs(transport: str = 'grpc', request_type=changelog.ListChangelogsRequest):
    client = ChangelogsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_changelog(transport: str = 'grpc', request_type=changelog.GetChangelogRequest):
    client = ChangelogsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
