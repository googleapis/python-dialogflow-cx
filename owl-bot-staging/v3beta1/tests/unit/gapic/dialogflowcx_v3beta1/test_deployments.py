...
from google.cloud.dialogflowcx_v3beta1.services.deployments.transports.base import _GOOGLE_AUTH_VERSION
...
def test_deployments_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_list_deployments(transport: str = 'grpc', request_type=deployment.ListDeploymentsRequest):
    client = DeploymentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_deployment(transport: str = 'grpc', request_type=deployment.GetDeploymentRequest):
    client = DeploymentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
