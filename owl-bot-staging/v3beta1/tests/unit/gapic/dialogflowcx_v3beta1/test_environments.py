...
from google.cloud.dialogflowcx_v3beta1.services.environments import EnvironmentsAsyncClient
...
from google.cloud.dialogflowcx_v3beta1.services.environments.transports.base import _API_CORE_VERSION
from google.cloud.dialogflowcx_v3beta1.services.environments.transports.base import _GOOGLE_AUTH_VERSION
...
def test_environments_client_client_options_from_dict():
    with mock.patch('google.cloud.dialogflowcx_v3beta1.services.environments.transports.EnvironmentsGrpcTransport.__init__') as grpc_transport:
...
def test_create_environment(transport: str = 'grpc', request_type=gcdc_environment.CreateEnvironmentRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_environment(transport: str = 'grpc', request_type=gcdc_environment.UpdateEnvironmentRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_lookup_environment_history(transport: str = 'grpc', request_type=environment.LookupEnvironmentHistoryRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_run_continuous_test(transport: str = 'grpc', request_type=environment.RunContinuousTestRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_continuous_test_results(transport: str = 'grpc', request_type=environment.ListContinuousTestResultsRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
async def test_list_continuous_test_results_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_continuous_test_results(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_environments_base_transport():
    ...
    with mock.patch('google.cloud.dialogflowcx_v3beta1.services.environments.transports.EnvironmentsTransport.__init__') as Transport:
...
def test_environments_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflowcx_v3beta1.services.environments.transports.EnvironmentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_environments_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflowcx_v3beta1.services.environments.transports.EnvironmentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.EnvironmentsTransport()
        adc.assert_called_once()
