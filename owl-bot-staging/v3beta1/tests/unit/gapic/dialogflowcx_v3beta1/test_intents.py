...
def test_create_intent_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("languageCode", )) & set(("parent", "intent", )))
...
def test_create_intent_rest_bad_request(transport: str = 'rest', request_type=gcdc_intent.CreateIntentRequest):
    client = IntentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_intent_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("languageCode", "updateMask", )) & set(("intent", )))
...
def test_update_intent_rest_bad_request(transport: str = 'rest', request_type=gcdc_intent.UpdateIntentRequest):
    client = IntentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_intents_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflowcx_v3beta1.services.intents.transports.IntentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_intents_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflowcx_v3beta1.services.intents.transports.IntentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.IntentsTransport()
        adc.assert_called_once()
