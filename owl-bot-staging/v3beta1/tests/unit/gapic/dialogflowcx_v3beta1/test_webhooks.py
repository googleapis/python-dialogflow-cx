...
@pytest.mark.parametrize("client_class", [
    WebhooksClient, WebhooksAsyncClient
])
@mock.patch.object(WebhooksClient, "DEFAULT_ENDPOINT", modify_default_endpoint(WebhooksClient))
@mock.patch.object(WebhooksAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(WebhooksAsyncClient))
...
def test_list_webhooks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.WebhooksRestInterceptor, "post_list_webhooks") as post, \
         mock.patch.object(transports.WebhooksRestInterceptor, "pre_list_webhooks") as pre:
        ...
        req.return_value._content = webhook.ListWebhooksResponse.to_json(webhook.ListWebhooksResponse())
        ...
        client.list_webhooks(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_webhooks_rest_bad_request(transport: str = 'rest', request_type=webhook.ListWebhooksRequest):
    client = WebhooksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_webhooks_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v3beta1/{parent=projects/*/locations/*/agents/*}/webhooks" % client.transport._host, args[1])
...
def test_get_webhook_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebhooksRestInterceptor, "post_get_webhook") as post, \
        ...
        client.get_webhook(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_webhook_rest_bad_request(transport: str = 'rest', request_type=webhook.GetWebhookRequest):
    client = WebhooksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_webhook_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3beta1/{name=projects/*/locations/*/agents/*/webhooks/*}" % client.transport._host, args[1])
...
def test_create_webhook_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "webhook", )))
...
def test_create_webhook_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebhooksRestInterceptor, "post_create_webhook") as post, \
         mock.patch.object(transports.WebhooksRestInterceptor, "pre_create_webhook") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.create_webhook(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_webhook_rest_bad_request(transport: str = 'rest', request_type=gcdc_webhook.CreateWebhookRequest):
    client = WebhooksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_webhook_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebhooksRestInterceptor, "post_update_webhook") as post, \
         mock.patch.object(transports.WebhooksRestInterceptor, "pre_update_webhook") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_webhook(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_webhook_rest_bad_request(transport: str = 'rest', request_type=gcdc_webhook.UpdateWebhookRequest):
    client = WebhooksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_webhook_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3beta1/{webhook.name=projects/*/locations/*/agents/*/webhooks/*}" % client.transport._host, args[1])
...
def test_delete_webhook_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebhooksRestInterceptor, "pre_delete_webhook") as pre:
        pre.assert_not_called()
        ...
        client.delete_webhook(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_webhook_rest_bad_request(transport: str = 'rest', request_type=webhook.DeleteWebhookRequest):
    client = WebhooksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
