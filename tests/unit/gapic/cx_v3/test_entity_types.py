...
from google.cloud.dialogflow.cx_v3.services.entity_types import EntityTypesAsyncClient
from google.cloud.dialogflow.cx_v3.services.entity_types import EntityTypesClient
from google.cloud.dialogflow.cx_v3.services.entity_types import pagers
from google.cloud.dialogflow.cx_v3.services.entity_types import transports
from google.cloud.dialogflow.cx_v3.types import entity_type
from google.cloud.dialogflow.cx_v3.types import entity_type as gcdc_entity_type
...
def test_entity_types_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflow.cx_v3.services.entity_types.transports.EntityTypesGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_entity_types_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflow.cx_v3.services.entity_types.transports.EntityTypesTransport.__init__"
    ) as Transport:
...
def test_entity_types_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.dialogflow.cx_v3.services.entity_types.transports.EntityTypesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
