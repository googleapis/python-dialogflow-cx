...
from google.cloud.dialogflow.cx_v3.services.flows import FlowsAsyncClient
from google.cloud.dialogflow.cx_v3.services.flows import FlowsClient
from google.cloud.dialogflow.cx_v3.services.flows import pagers
from google.cloud.dialogflow.cx_v3.services.flows import transports
from google.cloud.dialogflow.cx_v3.types import flow
from google.cloud.dialogflow.cx_v3.types import flow as gcdc_flow
from google.cloud.dialogflow.cx_v3.types import fulfillment
from google.cloud.dialogflow.cx_v3.types import page
from google.cloud.dialogflow.cx_v3.types import response_message
...
def test_flows_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflow.cx_v3.services.flows.transports.FlowsGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_flows_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflow.cx_v3.services.flows.transports.FlowsTransport.__init__"
    ) as Transport:
...
def test_flows_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.dialogflow.cx_v3.services.flows.transports.FlowsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
