...
from google.cloud.dialogflow.cx_v3.services.intents import IntentsAsyncClient
from google.cloud.dialogflow.cx_v3.services.intents import IntentsClient
from google.cloud.dialogflow.cx_v3.services.intents import pagers
from google.cloud.dialogflow.cx_v3.services.intents import transports
from google.cloud.dialogflow.cx_v3.types import intent
from google.cloud.dialogflow.cx_v3.types import intent as gcdc_intent
...
def test_intents_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflow.cx_v3.services.intents.transports.IntentsGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_intents_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflow.cx_v3.services.intents.transports.IntentsTransport.__init__"
    ) as Transport:
...
def test_intents_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.dialogflow.cx_v3.services.intents.transports.IntentsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
