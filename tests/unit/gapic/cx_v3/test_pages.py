...
from google.cloud.dialogflow.cx_v3.services.pages import PagesAsyncClient
from google.cloud.dialogflow.cx_v3.services.pages import PagesClient
from google.cloud.dialogflow.cx_v3.services.pages import pagers
from google.cloud.dialogflow.cx_v3.services.pages import transports
from google.cloud.dialogflow.cx_v3.types import fulfillment
from google.cloud.dialogflow.cx_v3.types import page
from google.cloud.dialogflow.cx_v3.types import page as gcdc_page
...
def test_pages_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflow.cx_v3.services.pages.transports.PagesGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_pages_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflow.cx_v3.services.pages.transports.PagesTransport.__init__"
    ) as Transport:
...
def test_pages_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.dialogflow.cx_v3.services.pages.transports.PagesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
