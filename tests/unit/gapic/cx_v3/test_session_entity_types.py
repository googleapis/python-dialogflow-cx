...
from google.cloud.dialogflow.cx_v3.services.session_entity_types import (
    SessionEntityTypesAsyncClient,
)
from google.cloud.dialogflow.cx_v3.services.session_entity_types import (
    SessionEntityTypesClient,
)
from google.cloud.dialogflow.cx_v3.services.session_entity_types import pagers
from google.cloud.dialogflow.cx_v3.services.session_entity_types import transports
...
def test_session_entity_types_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflow.cx_v3.services.session_entity_types.transports.SessionEntityTypesGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_session_entity_types_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflow.cx_v3.services.session_entity_types.transports.SessionEntityTypesTransport.__init__"
    ) as Transport:
...
def test_session_entity_types_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.dialogflow.cx_v3.services.session_entity_types.transports.SessionEntityTypesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
