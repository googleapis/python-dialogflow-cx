...
from google.cloud.dialogflow.cx_v3.services.sessions import SessionsAsyncClient
from google.cloud.dialogflow.cx_v3.services.sessions import SessionsClient
from google.cloud.dialogflow.cx_v3.services.sessions import transports
from google.cloud.dialogflow.cx_v3.types import audio_config
from google.cloud.dialogflow.cx_v3.types import entity_type
from google.cloud.dialogflow.cx_v3.types import intent
from google.cloud.dialogflow.cx_v3.types import page
from google.cloud.dialogflow.cx_v3.types import session
from google.cloud.dialogflow.cx_v3.types import session_entity_type
...
def test_sessions_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflow.cx_v3.services.sessions.transports.SessionsGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_sessions_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflow.cx_v3.services.sessions.transports.SessionsTransport.__init__"
    ) as Transport:
...
def test_sessions_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.dialogflow.cx_v3.services.sessions.transports.SessionsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
