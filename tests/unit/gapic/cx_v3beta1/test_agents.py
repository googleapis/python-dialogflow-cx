...
from google.cloud.dialogflow.cx_v3beta1.services.agents import AgentsAsyncClient
from google.cloud.dialogflow.cx_v3beta1.services.agents import AgentsClient
from google.cloud.dialogflow.cx_v3beta1.services.agents import pagers
from google.cloud.dialogflow.cx_v3beta1.services.agents import transports
from google.cloud.dialogflow.cx_v3beta1.types import agent
from google.cloud.dialogflow.cx_v3beta1.types import agent as gcdc_agent
...
def test_agents_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflow.cx_v3beta1.services.agents.transports.AgentsGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_agents_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflow.cx_v3beta1.services.agents.transports.AgentsTransport.__init__"
    ) as Transport:
...
def test_agents_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.dialogflow.cx_v3beta1.services.agents.transports.AgentsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
