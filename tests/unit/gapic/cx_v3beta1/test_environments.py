...
from google.cloud.dialogflow.cx_v3beta1.services.environments import (
    EnvironmentsAsyncClient,
)
from google.cloud.dialogflow.cx_v3beta1.services.environments import EnvironmentsClient
from google.cloud.dialogflow.cx_v3beta1.services.environments import pagers
from google.cloud.dialogflow.cx_v3beta1.services.environments import transports
from google.cloud.dialogflow.cx_v3beta1.types import environment
from google.cloud.dialogflow.cx_v3beta1.types import environment as gcdc_environment
...
def test_environments_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflow.cx_v3beta1.services.environments.transports.EnvironmentsGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_environments_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflow.cx_v3beta1.services.environments.transports.EnvironmentsTransport.__init__"
    ) as Transport:
...
def test_environments_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.dialogflow.cx_v3beta1.services.environments.transports.EnvironmentsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
