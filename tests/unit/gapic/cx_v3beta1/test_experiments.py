...
from google.cloud.dialogflow.cx_v3beta1.services.experiments import (
    ExperimentsAsyncClient,
)
from google.cloud.dialogflow.cx_v3beta1.services.experiments import ExperimentsClient
from google.cloud.dialogflow.cx_v3beta1.services.experiments import pagers
from google.cloud.dialogflow.cx_v3beta1.services.experiments import transports
from google.cloud.dialogflow.cx_v3beta1.types import experiment
from google.cloud.dialogflow.cx_v3beta1.types import experiment as gcdc_experiment
...
def test_experiments_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflow.cx_v3beta1.services.experiments.transports.ExperimentsGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_experiments_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflow.cx_v3beta1.services.experiments.transports.ExperimentsTransport.__init__"
    ) as Transport:
...
def test_experiments_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.dialogflow.cx_v3beta1.services.experiments.transports.ExperimentsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
