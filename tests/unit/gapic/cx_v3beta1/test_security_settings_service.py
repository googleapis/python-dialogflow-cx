...
from google.cloud.dialogflow.cx_v3beta1.services.security_settings_service import (
    SecuritySettingsServiceAsyncClient,
)
from google.cloud.dialogflow.cx_v3beta1.services.security_settings_service import (
    SecuritySettingsServiceClient,
)
from google.cloud.dialogflow.cx_v3beta1.services.security_settings_service import pagers
from google.cloud.dialogflow.cx_v3beta1.services.security_settings_service import (
    transports,
)
from google.cloud.dialogflow.cx_v3beta1.types import security_settings
...
def test_security_settings_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflow.cx_v3beta1.services.security_settings_service.transports.SecuritySettingsServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_security_settings_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflow.cx_v3beta1.services.security_settings_service.transports.SecuritySettingsServiceTransport.__init__"
    ) as Transport:
...
def test_security_settings_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.dialogflow.cx_v3beta1.services.security_settings_service.transports.SecuritySettingsServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
