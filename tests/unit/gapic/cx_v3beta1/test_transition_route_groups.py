...
from google.cloud.dialogflow.cx_v3beta1.services.transition_route_groups import (
    TransitionRouteGroupsAsyncClient,
)
from google.cloud.dialogflow.cx_v3beta1.services.transition_route_groups import (
    TransitionRouteGroupsClient,
)
from google.cloud.dialogflow.cx_v3beta1.services.transition_route_groups import pagers
from google.cloud.dialogflow.cx_v3beta1.services.transition_route_groups import (
    transports,
)
...
from google.cloud.dialogflow.cx_v3beta1.types import transition_route_group
from google.cloud.dialogflow.cx_v3beta1.types import (
...
def test_transition_route_groups_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflow.cx_v3beta1.services.transition_route_groups.transports.TransitionRouteGroupsGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_transition_route_groups_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflow.cx_v3beta1.services.transition_route_groups.transports.TransitionRouteGroupsTransport.__init__"
    ) as Transport:
...
def test_transition_route_groups_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.dialogflow.cx_v3beta1.services.transition_route_groups.transports.TransitionRouteGroupsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
