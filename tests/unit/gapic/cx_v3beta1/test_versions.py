...
from google.cloud.dialogflow.cx_v3beta1.services.versions import VersionsAsyncClient
from google.cloud.dialogflow.cx_v3beta1.services.versions import VersionsClient
from google.cloud.dialogflow.cx_v3beta1.services.versions import pagers
from google.cloud.dialogflow.cx_v3beta1.services.versions import transports
from google.cloud.dialogflow.cx_v3beta1.types import flow
from google.cloud.dialogflow.cx_v3beta1.types import version
from google.cloud.dialogflow.cx_v3beta1.types import version as gcdc_version
...
def test_versions_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflow.cx_v3beta1.services.versions.transports.VersionsGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_versions_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflow.cx_v3beta1.services.versions.transports.VersionsTransport.__init__"
    ) as Transport:
...
def test_versions_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.dialogflow.cx_v3beta1.services.versions.transports.VersionsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
