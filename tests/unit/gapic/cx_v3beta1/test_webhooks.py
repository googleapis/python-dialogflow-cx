...
from google.cloud.dialogflow.cx_v3beta1.services.webhooks import WebhooksAsyncClient
from google.cloud.dialogflow.cx_v3beta1.services.webhooks import WebhooksClient
from google.cloud.dialogflow.cx_v3beta1.services.webhooks import pagers
from google.cloud.dialogflow.cx_v3beta1.services.webhooks import transports
from google.cloud.dialogflow.cx_v3beta1.types import webhook
from google.cloud.dialogflow.cx_v3beta1.types import webhook as gcdc_webhook
...
def test_webhooks_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflow.cx_v3beta1.services.webhooks.transports.WebhooksGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_webhooks_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflow.cx_v3beta1.services.webhooks.transports.WebhooksTransport.__init__"
    ) as Transport:
...
def test_webhooks_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.dialogflow.cx_v3beta1.services.webhooks.transports.WebhooksTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
