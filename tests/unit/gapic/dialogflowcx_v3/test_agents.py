...
def test_agents_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflowcx_v3.services.agents.transports.AgentsGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_agents_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflowcx_v3.services.agents.transports.AgentsTransport.__init__"
    ) as Transport:
