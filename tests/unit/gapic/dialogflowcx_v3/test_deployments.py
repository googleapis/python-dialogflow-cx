...
def test_deployments_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflowcx_v3.services.deployments.transports.DeploymentsGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_deployments_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflowcx_v3.services.deployments.transports.DeploymentsTransport.__init__"
    ) as Transport:
...
def test_deployments_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.dialogflowcx_v3.services.deployments.transports.DeploymentsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
