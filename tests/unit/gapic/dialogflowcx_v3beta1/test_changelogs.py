...
def test_changelogs_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflowcx_v3beta1.services.changelogs.transports.ChangelogsGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_changelogs_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflowcx_v3beta1.services.changelogs.transports.ChangelogsTransport.__init__"
    ) as Transport:
...
def test_changelogs_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.dialogflowcx_v3beta1.services.changelogs.transports.ChangelogsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
